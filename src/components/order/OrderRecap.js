...
const OrderRecap = ({ sendValidateOrder }) => {
  ...
  const totalPrice = (array) => {
    ...
    for (let i = 0; i < array.length; i++) {
      if (
        (array[i][0].type === "naan" ||
          array[i][0].type === "classique" ||
          array[i][0].type === "wrap") &&
        array[i][0].menu === false
      ) {
  ...
  const modifyCart = (e) => {
    ...
    const newItem = [
      {
        ...itemToModify,
        prix: itemToModify.prixOriginal + supplement.length * 0.5,
        prixNoMenu: itemToModify.prixNoMenuOriginal + supplement.length * 0.5,
        menu,
        supplement,
        boisson,
        sauce,
                      ...
                      <Row>
                        ...
                        <Col md={6} className="d-flex justify-content-start">
                          <p className="recap-elements">
                            ...
                            <span>
                              {item.type === "assiettes"
                                ? capitalize(item.accompAssiette)
                                : capitalize(item.accompMenu)}
                            </span>
                          </p>
                        </Col>
                        <Col md={6} className="d-flex justify-content-start">
                        ...
                        <Col md={6} className="d-flex justify-content-start">
                          <p className="recap-elements">
                            Supplément:{" "}
                            <span>
                              {item.supplement.length
                                ? item.supplement.join(", ")
                                : "Aucun"}
                            </span>
                          </p>
                        </Col>
                      ...
                      <Form.Group as={Row}>
                        <Col sm={10}>
                          <Form.Check
                            ...
                            name="menu"
                            defaultChecked={
                              itemToModify.menu === true ? true : false
                            }
                          ...
                          <Form.Check
                            ...
                            name="menu"
                            defaultChecked={
                              itemToModify.menu === false ? true : false
                            }
                      ...
                      <Form.Group as={Row}>
                        <Col sm={10}>
                          <Form.Check
                            ...
                            defaultChecked={
                              itemToModify.accompAssiette === "Galette de Naan"
                                ? true
                                : false
                            }
                            onChange={(e) =>
                              setAccompAssiette("Galette de Naan")
                            }
                          />
                          <Form.Check
                            type="radio"
                            ...
                            name="assiettesAccomp"
                            defaultChecked={
                              itemToModify.accompAssiette === "Cheese Naan"
                                ? true
                                : false
                            }
                      ...
                      <Form.Group as={Row}>
                        <Col sm={10}>
                          <Form.Check
                            ...
                            name="menuAccomp"
                            defaultChecked={
                              itemToModify.accompMenu === "Frites"
                                ? true
                                : false
                            }
                          ...
                          <Form.Check
                            ...
                            name="menuAccomp"
                            defaultChecked={
                              itemToModify.accompMenu === "Riz" ? true : false
                            }
                    ...
                    <>
                      ...
                      <Form.Group controlId="formBasicCheckbox">
                        <Form.Check
                          ...
                          label="Mozzarella"
                          value="Mozzarella"
                          defaultChecked={itemToModify.supplement.includes(
                            "Mozzarella"
                          )}
