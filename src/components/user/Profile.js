        ...
        <Container className="h-100" fluid>
            ...
            <Row className="h-100">
                <Col className="h-100 d-flex align-items-center">
                    {error && <Alert variant="danger" className="my-4">Un problème est survenu pour la modification de votre email ou mot de passe</Alert>}
                    {updateSuccess && <Alert variant="success" className="my-4">Votre profil a été mis à jour</Alert>}
                    {updateFailed && <Alert variant="danger" className="my-4">Un problème est survenu avec la mise à jour de vos coordonnées</Alert>}
                                ...
                                <Form as={Row} onSubmit={handleSubmit}>
                                    <Col>
                                        ...
                                        <Form.Group as={Row} controlId="lastName">
                                            ...
                                            <Col sm={8}>
                                                <Form.Control type="text" placeholder="Dupont" defaultValue={user.name} ref={nameRef} />
                                            </Col>
                                        </Form.Group>
                                        ...
                                        <Form.Group as={Row} controlId="phone">
                                            ...
                                            <Col sm={8}>
                                                <Form.Control type="number" placeholder="XX.XX.XX.XX.XX" defaultValue={user.phone} ref={phoneRef} />
                                            </Col>
                                        </Form.Group>
                                    ...
                                    <Col>
                                        ...
                                        <Form.Group as={Row} controlId="address">
                                            ...
                                            <Col sm={8}>
                                                <Form.Control type="text" placeholder="14 rue Brocherie" defaultValue={user.address} ref={addressRef} />
                                            </Col>
                                        </Form.Group>
                                        <Form.Group as={Row} controlId="code-postal">
                                            <Form.Label column sm={4}>Code postal</Form.Label>
                                            <Col sm={8}>
                                                <Form.Control type="number" placeholder="38000" max="99999" defaultValue={user.zipCode} ref={zipCodeRef} />
                                            </Col>
                                        </Form.Group>
                                        <Form.Group as={Row} controlId="city">
                                            <Form.Label column sm={4}>Ville</Form.Label>
                                            <Col sm={8}>
                                                <Form.Control type="text" placeholder="Grenoble" defaultValue={user.city} ref={cityRef} />
                                            </Col>
                                        </Form.Group>
